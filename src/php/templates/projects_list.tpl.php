<?php if (count($data["participatingProjects"]) > 0 || ($data["user"]->admin && count($data["allProjects"]) > 0)) { ?>
...
<?php   } ?>
  <header class="main-header">
    <div class="main-header-header">
      ...
      <p class="main-subtitle"><?php if ($data["user"]->admin) { echo count($data["allProjects"])." Projekt"; if (count($data["allProjects"]) != 1) echo "e"; echo " angelegt"; } else { echo "An ".count($data["participatingProjects"])." Projekt"; if (count($data["participatingProjects"]) != 1) echo "en"; echo " beteiligt"; } ?></p>
    </div>
...
<?php   }
        if ($data["user"]->admin && count($data["participatingProjects"]) != count($data["allProjects"])) {
